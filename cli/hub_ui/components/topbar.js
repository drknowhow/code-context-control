    ...
    <header style={{
      ...
      {setMainView && (
        <div style={{
          ...
          {[['projects', 'Projects', 'layers'], ['board', 'Tasks', 'check'], ['ci', 'CI', 'play'], ['creds', 'Credentials', 'lock'], ['tokens', 'Tokens', 'gauge'], ['locks', 'Locks', 'gitBranch'], ['access', 'Access', 'eye'], ['enforce', 'Discipline', 'shield'], ['sessions', 'Sessions', 'messageSquare']].map(([id, label, icon]) => (
