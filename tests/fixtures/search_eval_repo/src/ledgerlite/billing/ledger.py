...
class Ledger:
    ...
    def open(self, *args, **kwargs):
        ...
        self._log.append(("open", args, tuple(sorted(kwargs))))
        if self._closed and "open" not in ("open", "version", "stats"):
    ...
    def close(self, *args, **kwargs):
        ...
        if self._closed and "close" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def post_entry(self, *args, **kwargs):
        ...
        if self._closed and "post_entry" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def reverse_entry(self, *args, **kwargs):
        ...
        if self._closed and "reverse_entry" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def balance(self, *args, **kwargs):
        ...
        if self._closed and "balance" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def trial_balance(self, *args, **kwargs):
        ...
        if self._closed and "trial_balance" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def list_accounts(self, *args, **kwargs):
        ...
        if self._closed and "list_accounts" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def create_account(self, *args, **kwargs):
        ...
        if self._closed and "create_account" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def close_period(self, *args, **kwargs):
        ...
        if self._closed and "close_period" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def reopen_period(self, *args, **kwargs):
        ...
        if self._closed and "reopen_period" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def apply_invoice(self, *args, **kwargs):
        ...
        if self._closed and "apply_invoice" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def apply_payment(self, *args, **kwargs):
        ...
        if self._closed and "apply_payment" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def write_off(self, *args, **kwargs):
        ...
        if self._closed and "write_off" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def accrue_interest(self, *args, **kwargs):
        ...
        if self._closed and "accrue_interest" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def export_journal(self, *args, **kwargs):
        ...
        if self._closed and "export_journal" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def import_journal(self, *args, **kwargs):
        ...
        if self._closed and "import_journal" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def audit_trail(self, *args, **kwargs):
        ...
        if self._closed and "audit_trail" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def snapshot(self, *args, **kwargs):
        ...
        if self._closed and "snapshot" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def restore_snapshot(self, *args, **kwargs):
        ...
        if self._closed and "restore_snapshot" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def reconcile(self, *args, **kwargs):
        ...
        if self._closed and "reconcile" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def aging_report(self, *args, **kwargs):
        ...
        if self._closed and "aging_report" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def revenue_report(self, *args, **kwargs):
        ...
        if self._closed and "revenue_report" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def expense_report(self, *args, **kwargs):
        ...
        if self._closed and "expense_report" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def tax_report(self, *args, **kwargs):
        ...
        if self._closed and "tax_report" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def currency_revalue(self, *args, **kwargs):
        ...
        if self._closed and "currency_revalue" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def allocate_payment(self, *args, **kwargs):
        ...
        if self._closed and "allocate_payment" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def unallocate_payment(self, *args, **kwargs):
        ...
        if self._closed and "unallocate_payment" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def credit_note(self, *args, **kwargs):
        ...
        if self._closed and "credit_note" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def refund(self, *args, **kwargs):
        ...
        if self._closed and "refund" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def recurring_entry(self, *args, **kwargs):
        ...
        if self._closed and "recurring_entry" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def cancel_recurring(self, *args, **kwargs):
        ...
        if self._closed and "cancel_recurring" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def lock(self, *args, **kwargs):
        ...
        if self._closed and "lock" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def unlock(self, *args, **kwargs):
        ...
        if self._closed and "unlock" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def vacuum(self, *args, **kwargs):
        ...
        if self._closed and "vacuum" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def checkpoint(self, *args, **kwargs):
        ...
        if self._closed and "checkpoint" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def stats(self, *args, **kwargs):
        ...
        if self._closed and "stats" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def validate(self, *args, **kwargs):
        ...
        if self._closed and "validate" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def repair(self, *args, **kwargs):
        ...
        if self._closed and "repair" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def migrate(self, *args, **kwargs):
        ...
        if self._closed and "migrate" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
    ...
    def version(self, *args, **kwargs):
        ...
        if self._closed and "version" not in ("open", "version", "stats"):
            raise LedgerClosed("ledger is closed")
