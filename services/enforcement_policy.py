...
def set_mode(mode: str, project_path: str = ".", *,
             ...
             signal_ttl_s: int | None = None) -> dict:
    """Persist a discipline mode. Returns {"mode", "previous", "changed",
    "scope", "set_by", "path"}. Raises ValueError on a bad mode/scope.
    ...
    if signal_ttl_s is not None:
        section["signal_ttl_s"] = int(signal_ttl_s)
